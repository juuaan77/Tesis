...
\begin{frame}{Arquitectura}
    ...
    \begin{figure}[ht]
       \centering
       \vspace{-0.50cm}
       \scalebox{0.35}{\includegraphics[angle=0]{./figuras/ArquitecturaDeDesarrolloEnUnEntornoMixto.png}}
    \end{figure}
...
\begin{frame}{Desarrollo - Orquestación}
    \vspace{-1.5cm}
        \begin{figure}[ht]
           \centering
           \vspace{-0.50cm}
           \scalebox{0.25}{\includegraphics[angle=0]{./figuras/PuppetLabsEnforceDesiredState.png}}
