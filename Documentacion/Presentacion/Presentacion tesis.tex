...
\begin{frame}{Desarrollo - Orquestación}
    ...
    \begin{figure}[ht]
       \centering
       \scalebox{0.3}{\includegraphics[angle=0]{./figuras/orquestacion-modulos-puppet.png}}
    \end{figure}
...
\begin{frame}{Desarrollo - Orquestación}
    ...
    \begin{figure}[ht]
       \centering
       \scalebox{0.3}{\includegraphics[angle=0]{./figuras/orquestacion-codigo-puppet.png}}
    \end{figure}
