...
\begin{frame}{Desarrollo - Servidor de virtualización}
    \begin{figure}[!tbp]
      \centering
      \begin{minipage}[b]{0.4\textwidth}
        \scalebox{1.2}{\includegraphics[width=\textwidth]{./figuras/kvm_virt_install.png}}
        \caption{\scriptsize Creación VM}
      \end{minipage}
      \hfill
      \begin{minipage}[b]{0.4\textwidth}
        \scalebox{1.2}{\includegraphics[width=\textwidth]{./figuras/kvm_virsh.png}}
...
\begin{frame}{Desarrollo - Servidor de orquestación}
    ...
    \begin{figure}[ht]
       \centering
       \scalebox{0.5}{\includegraphics[angle=0]{./figuras/orquestacion-codigo-puppet-2.png}}
    \end{figure}
...
\begin{frame}{Desarrollo - Servidor de orquestación}
    ...
    \begin{figure}[ht]
       \centering
       \scalebox{0.4}{\includegraphics[angle=0]{./figuras/orquestacion-codigo-puppet-1.png}}
    \end{figure}
