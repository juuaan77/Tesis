...
\begin{frame}{Trabajos Futuros}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item Implementación en un entorno híbrido, con máquinas en la nube y en un servidor físico de alto rendimiento
...
\begin{frame}{Trabajos Futuros}
    \vspace{0cm}
    \begin{itemize}
        \item Integrar utilizando herramientas de Continuous Integration y Continuous Delivery
        \item Brindar servicios locales o en la nube utilizando Linux Containers dentro de las máquinas virtuales
