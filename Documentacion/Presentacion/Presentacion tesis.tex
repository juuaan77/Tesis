...
\begin{frame}{Arquitectura}
    ...
    \begin{figure}[ht]
       \centering
       \vspace{-0.50cm}
       \scalebox{0.25}{\includegraphics[angle=0]{./figuras/Crear_VM.png}}
    \end{figure}
...
\begin{frame}{Desarrollo - Virtualización}
    ...
    \begin{figure}[ht]
       %\centering
       %\raggedright \hspace*{4cm}
       \vspace{-0.50cm} 
       \scalebox{0.30}{\includegraphics[angle=0]{./figuras/kvm_arquitectura_1.png}}
    \end{figure}
...
\begin{frame}{Desarrollo - Virtualización}
    ...
    \fontsize{8pt}{12pt}\selectfont
        ...
        \# virt-install \textbackslash \\
           ...
           \hspace{0.75cm} --name=centos-vm \textbackslash \\
           ...
           \hspace{0.75cm} --os-variant=centos7
        }    
    \endgroup
...
\begin{frame}{Desarrollo - Orquestación}
    ...
    \begin{figure}[ht]
       \centering
       \scalebox{0.5}{\includegraphics[angle=0]{./figuras/orquestacion-modulos-puppet.png}}
    \end{figure}
...
\begin{frame}{Desarrollo - Orquestación}
    ...
    \begin{figure}[ht]
       \centering
       \scalebox{0.45}{\includegraphics[angle=0]{./figuras/orquestacion-codigo-puppet.png}}
    \end{figure}
