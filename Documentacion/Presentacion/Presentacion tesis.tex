...
\begin{frame}{Desarrollo - Aprovisionamiento}
    ...
    \begin{figure}[ht]
       \centering
       \vspace{-0.50cm}
       \scalebox{0.38}{\includegraphics[angle=0]{./figuras/Aprovisionamiento.png}}
    \end{figure}
\end{frame}
...
\begin{frame}{Desarrollo - Orquestación}
    ...
    \vspace{0cm}
        \begin{figure}[ht]
           \centering
           \scalebox{0.38}{\includegraphics[angle=0]{./figuras/Orquestacion.png}}
        \end{figure}
...
\begin{frame}{Desarrollo - Orquestación}
    ...
    \begin{figure}[ht]
       \centering
       \scalebox{0.4}{\includegraphics[angle=0]{./figuras/orquestacion-codigo-puppet.png}}
    \end{figure}
